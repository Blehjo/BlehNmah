    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
                ...
                DbContextOptions<RazorPagesGalleryContext>>()))
        {
            ...
            context.Collection.AddRange(
                ...
                new Collection { CollectionName = "Bahai'i Temple", CoverImage = "https://i.imgur.com/f1Mu1M8.jpg", Description = "Were faces the first masks? With no where to hide, we put on faces and convince ourselves we're ready for action. Come and explore some of these notions.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Dominica", CoverImage = "https://i.imgur.com/PrKhNgQ.jpg", Description = "Animals are some of our first inspirations in art. We look to animals for spiritual connections and tapping into who we aspire to be.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Peacock", CoverImage = "https://i.imgur.com/LwXY8W9.jpg", Description = "Some of Bleh Nmah's early works. Simply testing out techniques and materials. We begin to see some instances of hiding our everyday face.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Hair Wars", CoverImage = "https://i.imgur.com/dYTirol.jpg", Description = "So much inspiration with the word LOVE. So much motivation. Bleh Nmah created so much art because of Love and will continue to do so. Let's give it up for love.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Lights", CoverImage = "https://i.imgur.com/8hs8fF3.jpg", Description = "Inspired by Piet Modrian and Paul Klee. We explore color theory and the emotion that comes with it. We see the experiments and begin to understand how color combinations can evoke feelings.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Landscapes", CoverImage = "https://i.imgur.com/9Il1Fbi.jpg", Description = "Bleh Nmah is a shy person at heart. We see that in this collection 'Hidden.' So many tools out there to help us hide or help us stand out. Depends on how you look at it I guess.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "MCA", CoverImage = "https://i.imgur.com/oPrtU71.jpg", Description = "A bit of a slow time to experiment and try out some ideas. If you like to people watch and are open to new ideas. This is the collection for you.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Mercedes", CoverImage = "https://i.imgur.com/UA9uVe6.jpg", Description = "Speaks for itself. This is the city that Bleh Nmah grew up in. The city can make you feel wonderful and horrible at the same time. It's all up to how you approach it. Good luck!", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Monsters", CoverImage = "https://i.imgur.com/R34Y4HB.jpg", Description = "Speaks for itself. This is the city that Bleh Nmah grew up in. The city can make you feel wonderful and horrible at the same time. It's all up to how you approach it. Good luck!", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Miro", CoverImage = "https://i.imgur.com/7Nxg9uE.jpg", Description = "Study of Fulani and the influence of the Fulani people on west Africa. Masks begin to be used more in my art. A fascination begins on how people use masks to tap into different egos.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Tanzania", CoverImage = "https://i.imgur.com/NqzeSiu.jpg", Description = "Full on study of masks and how it's much more than hiding who people are. Masks are used to become different parts of ourselves and communicate with people who feel the same as us.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Sedona", CoverImage = "https://i.imgur.com/GRPmeN5.jpg", Description = "Study of Fulani and the influence of the Fulani people on west Africa. Masks begin to be used more in my art. A fascination begins on how people use masks to tap into different egos.", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Art Institute", CoverImage = "https://i.imgur.com/fHP6ZfJ.jpg", Description = "Full on study of masks and how it's much more than hiding who people are. Masks are used to become different parts of ourselves and communicate with people who feel the same as us.", Year = DateTime.Parse("2005-09-01") }
            );
            context.SaveChanges();
            ...
            context.Photograph.AddRange(
                new Photograph { CollectionID = 23, Title = "Statues in the garden", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Chicago, Illinois", MediaLocation = "https://i.imgur.com/fHP6ZfJ.jpg" },
                new Photograph { CollectionID = 23, Title = "Statues reflection", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Chicago, Illinois", MediaLocation = "https://i.imgur.com/31kPKHX.jpg" },
                new Photograph { CollectionID = 23, Title = "Statues' reflections", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Chicago, Illinois", MediaLocation = "https://i.imgur.com/PzdXe5c.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona cliffs", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Arizona", MediaLocation = "https://i.imgur.com/yXYoEuN.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona during noon", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Arizona", MediaLocation = "https://i.imgur.com/GRPmeN5.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona landscape", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Arizona", MediaLocation = "https://i.imgur.com/CNikcPi.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona landscape 2", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Location", MediaLocation = "https://i.imgur.com/KlsbX3h.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona landscape 3", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Location", MediaLocation = "https://i.imgur.com/mczIgi4.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona landscape 4", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Location", MediaLocation = "https://i.imgur.com/h1vHXBY.jpg" },
                ...
                new Photograph { CollectionID = 21, Title = "Sunset I", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/fD8A1Hn.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/KNJssgW.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset III", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/K8rCgos.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset IV", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/mbi0oM6.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset V", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/pHe4RQO.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset VI", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/hgxLSzW.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset VII", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/NSOLlE0.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset VIII", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/AD6m4mF.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset IX", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/VzgXJgx.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset X", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/juzL3LN.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset XI", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/7g69BHq.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset XII", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/TyJ1nkd.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset XIII", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Zanzibar, Tanzania", MediaLocation = "https://i.imgur.com/7vOzCtv.jpg" },
                new Photograph { CollectionID = 21, Title = "Kilimanjaro Boat", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/CzhYtgx.jpg" },
                new Photograph { CollectionID = 21, Title = "Landscape", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/08PhWJb.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/sLVaVL7.jpg" },
                new Photograph { CollectionID = 21, Title = "Big Cats", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/zAcJNss.jpg" },
                new Photograph { CollectionID = 21, Title = "Resort", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/hZ9hGtx.jpg" },
                new Photograph { CollectionID = 21, Title = "Gas Station", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/NBWs6aw.jpg" },
                new Photograph { CollectionID = 21, Title = "Lioness", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/lRpSijZ.jpg" },
                new Photograph { CollectionID = 21, Title = "Baboon", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/K2AK3LQ.jpg" },
                new Photograph { CollectionID = 21, Title = "Mountain Blur", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/k3HtvcR.jpg" },
                new Photograph { CollectionID = 21, Title = "Lion under the tree", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/q22XLuG.jpg" },
                new Photograph { CollectionID = 21, Title = "Resort II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/8mJeCRA.jpg" },
                new Photograph { CollectionID = 21, Title = "Lions sleeping", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/dtRNdI8.jpg" },
                new Photograph { CollectionID = 21, Title = "Blurry Boat", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/Hb0F3pp.jpg" },
                new Photograph { CollectionID = 21, Title = "Migration", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/0Mvq5Xk.jpg" },
                new Photograph { CollectionID = 21, Title = "Sails", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/KQa6sNV.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephant", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/5WpvQDV.jpg" },
                new Photograph { CollectionID = 21, Title = "Late night Fishing", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/55GrbwX.jpg" },
                new Photograph { CollectionID = 21, Title = "Resort III", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/aih946k.jpg" },
                new Photograph { CollectionID = 21, Title = "Market", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/LEeDUUh.jpg" },
                new Photograph { CollectionID = 21, Title = "Lionesses in tree", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/6FL4mhV.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/Z1DmW6a.jpg" },
                new Photograph { CollectionID = 21, Title = "Market II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/Y3LSLtO.jpg" },
                new Photograph { CollectionID = 21, Title = "Palm Tree", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/NaQau1u.jpg" },
                new Photograph { CollectionID = 21, Title = "The block", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/RaXoM4p.jpg" },
                new Photograph { CollectionID = 21, Title = "Giraffe in the distance", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/XtE3qdc.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/fQnHxyh.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribes", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/oNuqTOe.jpg" },
                new Photograph { CollectionID = 21, Title = "Mountains", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/ACl7kAx.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribal Ladies", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/EhnHPkP.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribal Ladies II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/NqzeSiu.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribal Ladies III", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/BEIcwEa.jpg" },
                new Photograph { CollectionID = 21, Title = "Giraffes", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/lh0H3cL.jpg" },
                new Photograph { CollectionID = 21, Title = "Cloudy", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/BgeIKNA.jpg" },
                new Photograph { CollectionID = 21, Title = "Gas Station", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/ZWN2iBx.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/YgQgk5K.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephants", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/1qgzTys.jpg" },
                new Photograph { CollectionID = 21, Title = "Sailboat", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/ZbO3OQn.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephant eating", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/2r5nqnh.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/fQO4VTi.jpg" },
                new Photograph { CollectionID = 21, Title = "Cows on the move", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/0uEYybj.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat eyes", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/eOlbglR.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/ZuRkPh1.jpg" },
                new Photograph { CollectionID = 21, Title = "Field II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/s8r6BWi.jpg" },
                new Photograph { CollectionID = 21, Title = "Gas Station II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/MiAoTJd.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake III", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/zWHBNVZ.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephant in the field", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/UjmUyDs.jpg" },
                new Photograph { CollectionID = 21, Title = "Beautiful day", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/sx7O1cc.jpg" },
                new Photograph { CollectionID = 21, Title = "Lone Elephant", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/cGNCmQm.jpg" },
                new Photograph { CollectionID = 21, Title = "Blurry sun", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/fpVKT0V.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras III", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/tSX7wzV.jpg" },
                new Photograph { CollectionID = 21, Title = "Sailboat POV", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/zK51CAR.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunrise to Sunset", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/D64B9DN.jpg" },
                new Photograph { CollectionID = 21, Title = "Lone Elephant II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/8fReugx.jpg" },
                new Photograph { CollectionID = 21, Title = "Monkeys in a tree", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/c1VsDOh.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribes II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/yMPlMCb.jpg" },
                new Photograph { CollectionID = 21, Title = "Field view", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/SuP7vbH.jpg" },
                new Photograph { CollectionID = 21, Title = "Lionesses in the tree II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/oKkU9Jv.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake IV", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/Yfn4J4L.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap III", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/eKnvHKO.jpg" },
                new Photograph { CollectionID = 21, Title = "Field view", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/TfiTzgm.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap IV", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/vE3ozYS.jpg" },
                new Photograph { CollectionID = 21, Title = "Palm tree long", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/Rejm0jY.jpg" },
                new Photograph { CollectionID = 21, Title = "Setting sun", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/dhnQ81v.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunrise to sunset II", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/O12IA3l.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/A1X61L0.jpg" },
                new Photograph { CollectionID = 21, Title = "Cows", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/L8oyjLr.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake V", Description = "", Year = DateTime.Parse("2022-08-07"), Location = "Tanzania", MediaLocation = "https://i.imgur.com/whti7FO.jpg" }
            );
            context.SaveChanges();
        }
    }
