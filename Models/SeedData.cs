    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
                ...
                DbContextOptions<RazorPagesGalleryContext>>()))
        {
            ...
            context.Collection.AddRange(
                ...
                new Collection { CollectionName = "Bahai'i Temple", CoverImage = "https://i.imgur.com/f1Mu1M8.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Dominica", CoverImage = "https://i.imgur.com/PrKhNgQ.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Peacock", CoverImage = "https://i.imgur.com/LwXY8W9.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Hair Wars", CoverImage = "https://i.imgur.com/dYTirol.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Lights", CoverImage = "https://i.imgur.com/8hs8fF3.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Landscapes", CoverImage = "https://i.imgur.com/9Il1Fbi.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "MCA", CoverImage = "https://i.imgur.com/oPrtU71.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Mercedes", CoverImage = "https://i.imgur.com/UA9uVe6.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Monsters", CoverImage = "https://i.imgur.com/R34Y4HB.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Miro", CoverImage = "https://i.imgur.com/7Nxg9uE.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Tanzania", CoverImage = "https://i.imgur.com/NqzeSiu.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Sedona", CoverImage = "https://i.imgur.com/GRPmeN5.jpg", Year = DateTime.Parse("2005-09-01") },
                new Collection { CollectionName = "Art Institute", CoverImage = "https://i.imgur.com/fHP6ZfJ.jpg", Year = DateTime.Parse("2005-09-01") }
            );
            context.SaveChanges();
            ...
            context.Photograph.AddRange(
                ...
                new Photograph { CollectionID = 22, Title = "Sedona landscape 2", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Arizona", MediaLocation = "https://i.imgur.com/KlsbX3h.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona landscape 3", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Arizona", MediaLocation = "https://i.imgur.com/mczIgi4.jpg" },
                new Photograph { CollectionID = 22, Title = "Sedona landscape 4", Description = "", Year = DateTime.Parse("2021-09-07"), Location = "Sedona, Arizona", MediaLocation = "https://i.imgur.com/h1vHXBY.jpg" },
                ...
                new Photograph { CollectionID = 13, Title = "Peacock", Description = "", Year = DateTime.Parse("2018-10-13"), Location = "Austin, Texas", MediaLocation = "https://i.imgur.com/QbqRzsG.jpg" },
