    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
                ...
                DbContextOptions<RazorPagesGalleryContext>>()))
        {
            ...
            context.Painting.AddRange(
                ...
                new Painting { CollectionID = 7, Title = "Stuck in the city", MediaLocation = "https://i.imgur.com/18qMbhe.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                ...
                new Painting { CollectionID = 7, Title = "City Slickers", MediaLocation = "https://i.imgur.com/2E31Osn.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 7, Title = "Hidden Love", MediaLocation = "https://i.imgur.com/9Il1Fbi.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 1", MediaLocation = "https://i.imgur.com/aX6EgSZ.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 2", MediaLocation = "https://i.imgur.com/g7aqfDg.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 3", MediaLocation = "https://i.imgur.com/OYueUbI.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 4", MediaLocation = "https://i.imgur.com/u3BP1Es.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 5", MediaLocation = "https://i.imgur.com/0zC38o9.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 6", MediaLocation = "https://i.imgur.com/AchglF9.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 7", MediaLocation = "https://i.imgur.com/o9EBHty.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 8", MediaLocation = "https://i.imgur.com/BPThcCQ.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 8, Title = "Print 9", MediaLocation = "https://i.imgur.com/v3viNdd.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 9, Title = "The round table", MediaLocation = "https://i.imgur.com/tiW0qSX.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 9, Title = "Sunnyside", MediaLocation = "https://i.imgur.com/O2mvWFE.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" },
                new Painting { CollectionID = 9, Title = "Friends", MediaLocation = "https://i.imgur.com/3ykA5Wa.jpg", Description = "", Year = DateTime.Parse("2018-09-01"), Medium = "Chalk, Paper", Location = "Chicago, Illinois" }
            );
            context.SaveChanges();
            ...
            context.Photograph.AddRange(
                ...
                new Photograph { CollectionID = 13, Title = "Peacock", Description = "", Year = DateTime.Parse("2018-10-13"), Location = "", MediaLocation = "https://i.imgur.com/QbqRzsG.jpg" },
                ...
                new Photograph { CollectionID = 20, Title = "The Sun the Moon, and Star", Description = "", Year = DateTime.Parse("2018-09-13"), Location = "", MediaLocation = "https://i.imgur.com/Wd9NLEn.jpg" },
                new Photograph { CollectionID = 20, Title = "The Sun the Moon, and Star", Description = "", Year = DateTime.Parse("2018-09-13"), Location = "", MediaLocation = "https://i.imgur.com/7Nxg9uE.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/fD8A1Hn.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/KNJssgW.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/K8rCgos.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/mbi0oM6.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/pHe4RQO.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/hgxLSzW.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/NSOLlE0.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/AD6m4mF.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/VzgXJgx.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/juzL3LN.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/7g69BHq.jpg" },
                new Photograph { CollectionID = 21, Title = "", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/TyJ1nkd.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunset", Description = "", Year = DateTime.Parse(""), Location = "Zanzibar, Tanzania", MediaLocation = "https://i.imgur.com/7vOzCtv.jpg" },
                new Photograph { CollectionID = 21, Title = "Kilimanjaro Boat", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/CzhYtgx.jpg" },
                ...
                new Photograph { CollectionID = 21, Title = "Zebras", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/sLVaVL7.jpg" },
                new Photograph { CollectionID = 21, Title = "Big Cats", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/zAcJNss.jpg" },
                new Photograph { CollectionID = 21, Title = "Resort", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/hZ9hGtx.jpg" },
                new Photograph { CollectionID = 21, Title = "Gas Station", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/NBWs6aw.jpg" },
                new Photograph { CollectionID = 21, Title = "Lioness", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/lRpSijZ.jpg" },
                new Photograph { CollectionID = 21, Title = "Baboon", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/K2AK3LQ.jpg" },
                new Photograph { CollectionID = 21, Title = "Mountain Blur", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/k3HtvcR.jpg" },
                new Photograph { CollectionID = 21, Title = "Lion under the tree", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/q22XLuG.jpg" },
                new Photograph { CollectionID = 21, Title = "Resort II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/8mJeCRA.jpg" },
                new Photograph { CollectionID = 21, Title = "Lions sleeping", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/dtRNdI8.jpg" },
                new Photograph { CollectionID = 21, Title = "Blurry Boat", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/Hb0F3pp.jpg" },
                new Photograph { CollectionID = 21, Title = "Migration", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/0Mvq5Xk.jpg" },
                new Photograph { CollectionID = 21, Title = "Sails", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/KQa6sNV.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephant", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/5WpvQDV.jpg" },
                new Photograph { CollectionID = 21, Title = "Late night Fishing", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/55GrbwX.jpg" },
                new Photograph { CollectionID = 21, Title = "Resort III", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/aih946k.jpg" },
                new Photograph { CollectionID = 21, Title = "Market", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/LEeDUUh.jpg" },
                new Photograph { CollectionID = 21, Title = "Lionesses in tree", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/6FL4mhV.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/Z1DmW6a.jpg" },
                new Photograph { CollectionID = 21, Title = "Market II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/Y3LSLtO.jpg" },
                new Photograph { CollectionID = 21, Title = "Palm Tree", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/NaQau1u.jpg" },
                new Photograph { CollectionID = 21, Title = "The block", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/RaXoM4p.jpg" },
                new Photograph { CollectionID = 21, Title = "Giraffe in the distance", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/XtE3qdc.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/fQnHxyh.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribes", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/oNuqTOe.jpg" },
                new Photograph { CollectionID = 21, Title = "Mountains", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/ACl7kAx.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribal Ladies", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/EhnHPkP.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribal Ladies II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/NqzeSiu.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribal Ladies III", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/BEIcwEa.jpg" },
                new Photograph { CollectionID = 21, Title = "Giraffes", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/lh0H3cL.jpg" },
                new Photograph { CollectionID = 21, Title = "Cloudy", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/BgeIKNA.jpg" },
                new Photograph { CollectionID = 21, Title = "Gas Station", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/ZWN2iBx.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/YgQgk5K.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephants", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/1qgzTys.jpg" },
                new Photograph { CollectionID = 21, Title = "Sailboat", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/ZbO3OQn.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephant eating", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/2r5nqnh.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/fQO4VTi.jpg" },
                new Photograph { CollectionID = 21, Title = "Cows on the move", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/0uEYybj.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat eyes", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/eOlbglR.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/ZuRkPh1.jpg" },
                new Photograph { CollectionID = 21, Title = "Field II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/s8r6BWi.jpg" },
                new Photograph { CollectionID = 21, Title = "Gas Station II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/MiAoTJd.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake III", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/zWHBNVZ.jpg" },
                new Photograph { CollectionID = 21, Title = "Elephant in the field", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/UjmUyDs.jpg" },
                new Photograph { CollectionID = 21, Title = "Beautiful day", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/sx7O1cc.jpg" },
                new Photograph { CollectionID = 21, Title = "Lone Elephant", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/cGNCmQm.jpg" },
                new Photograph { CollectionID = 21, Title = "Blurry sun", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/fpVKT0V.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras III", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/tSX7wzV.jpg" },
                new Photograph { CollectionID = 21, Title = "Sailboat POV", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/zK51CAR.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunrise to Sunset", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/D64B9DN.jpg" },
                new Photograph { CollectionID = 21, Title = "Lone Elephant II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/8fReugx.jpg" },
                new Photograph { CollectionID = 21, Title = "Monkeys in a tree", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/c1VsDOh.jpg" },
                new Photograph { CollectionID = 21, Title = "Tribes II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/yMPlMCb.jpg" },
                new Photograph { CollectionID = 21, Title = "Field view", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/SuP7vbH.jpg" },
                new Photograph { CollectionID = 21, Title = "Lionesses in the tree II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/oKkU9Jv.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake IV", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/Yfn4J4L.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap III", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/eKnvHKO.jpg" },
                new Photograph { CollectionID = 21, Title = "Field view", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/TfiTzgm.jpg" },
                new Photograph { CollectionID = 21, Title = "Cat nap IV", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/vE3ozYS.jpg" },
                new Photograph { CollectionID = 21, Title = "Palm tree long", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/Rejm0jY.jpg" },
                new Photograph { CollectionID = 21, Title = "Setting sun", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/dhnQ81v.jpg" },
                new Photograph { CollectionID = 21, Title = "Sunrise to sunset II", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/O12IA3l.jpg" },
                new Photograph { CollectionID = 21, Title = "Zebras", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/A1X61L0.jpg" },
                new Photograph { CollectionID = 21, Title = "Cows", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/L8oyjLr.jpg" },
                new Photograph { CollectionID = 21, Title = "Lake V", Description = "", Year = DateTime.Parse(""), Location = "", MediaLocation = "https://i.imgur.com/whti7FO.jpg" }
            );
            context.SaveChanges();
        }
    }
